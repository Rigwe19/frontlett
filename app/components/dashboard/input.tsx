import React, { createElement, memo, useEffect, useState, type ReactNode } from 'react'
...
const Input = ({ type, icon, className, error, info, placeholder, label, prefix, ...props }: Props) => {
