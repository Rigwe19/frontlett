            ...
            <div className="flex flex-col w-9/10 xl:w-7/10 justify-center items-center flex-1 gap-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full">
                    ...
                    <div className="flex flex-col gap-2.5 items-center w-full">
                        ...
                        <button onClick={googleAuth} type="button" className="border flex gap-1 w-full rounded-xl h-[45px] items-center dark:border-neutral-500 border-[#EEEEEE] justify-center">
